...
# ================= 配置路径 =================
REF_VIDEO_DIR = '/home/users/astar/cfar/stuchengyou/jcy/xcl/Magic-TryOn/temp/vap_train_data_final/test/split_videos_ref/part_2'
...
state_dict = load_state_dict("models/train_0301_new/Video-As-Prompt-Wan2.1-14B_full/epoch-1.safetensors")
